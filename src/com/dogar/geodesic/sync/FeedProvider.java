...
public class FeedProvider extends ContentProvider {
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch (match) {
		case ROUTE_ENTRIES:
			long id = db.insertOrThrow(FeedContract.Entry.TABLE_NAME, null,
					values);
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case ROUTE_ENTRIES:
			...
			builder.table(FeedContract.Entry.TABLE_NAME).where(selection,
					selectionArgs);
	 ...
	 * FeedProvider. This database should never be accessed by other parts of
	 * the application directly.
	 */
	private static class FeedDatabase extends SQLiteOpenHelper {
		/** Schema version. */
		...
		private static final String SQL_CREATE_ENTRIES = "CREATE TABLE "
				...
				+ TYPE_TEXT + COMMA_SEP
				+ FeedContract.Entry.COLUMN_NAME_LONGITUDE + TYPE_TEXT
				...
				+ COMMA_SEP + FeedContract.Entry.COLUMN_NAME_DIRTY
				+ TYPE_INTEGER + ")";
